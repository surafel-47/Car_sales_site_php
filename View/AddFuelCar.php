...
<body>
  ...
  <section class="mainPanel">
    <form class="addProdForm" action="../Controller/AddFuelController.php" method="post"  enctype="multipart/form-data">
      <div class="formLeft">
        <p>Car Name</p>
        ...
        <p>Car Mile Age (Km) </p>
        <input class="inputTextField" type="number" id="mileage" name="mileage" required />
        <p>KM Per Liter Travel</p>
        <input class="inputTextField" type="number" id="kmPerLiter" name="kmPerLiter" required />
        <p>Fuel Capcity (Liters) </p>
        <input class="inputTextField" id="fuelCapacity" name="fuelCapacity" required />
